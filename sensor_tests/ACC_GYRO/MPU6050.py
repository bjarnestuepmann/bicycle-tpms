...
# SMPLRT_DIV
print("Output Sample Rate Divider: ", bus.read_byte_data(address, 0x19))

# DLPF_CFG
print("Output Digital Low pass filter Output : ", get_dlpf_cfg())

# Gyro Scope
print(bus.read_byte_data(address, 0x1b))
